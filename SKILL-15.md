...
**Nếu bỏ qua bất kỳ bước nào → dừng lại, quay về bước đó trước khi tiếp tục.**
...
11. **Chạy PROTOCOL 5 bước** trước khi viết `com()` cho bất kỳ chương nào (grep → cat → grep đếm → in danh sách → sed kiểm tra)
...
| Bỏ sót footnote entry cả chương | Không chạy PROTOCOL 5 bước | Chạy grep/cat/grep đếm/danh sách/sed theo thứ tự |
